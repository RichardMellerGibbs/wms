angular.module('maintGalleryCtrl', ['authService','successService','logService'])
.controller('maintGalleryController', ['$rootScope', '$location', '$routeParams', '$window', 'Auth', 'Success', 'Log',  
function($rootScope, $location, $routeParams, $window, Auth, Success, Log) {  
    ...
    if (vm.loggedIn === false) {
        ...
        if ($routeParams.galleryId !== 'x') {
            ...
            Log.logEntry('Now get the gallery details for this article ' + vm.galleryId);
    ...
    vm.updateGallery = function() {
        ...
        Success.update(vm.galleryId, articletData)
        .success(function(data) {
