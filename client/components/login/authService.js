angular
  .module('authService', ['storeageFallback', 'logService'])
  ...
  .factory('Auth', function ($http, $q, AuthToken, Browser) {
    ...
    authFactory.forgotPassword = function (username) {
      ...
      return $http
        ...
        .success(function (data) {
          console.log(
            'Auth factory - ' + data.message + ' and success = ' + data.success
          );
        ...
        .error(function () {
          console.log(
            'Auth factory - failed to call forgot password ' + data.message
          );
        });
    };
    ...
    authFactory.checkForgotPassword = function (token) {
      return $http
        ...
        .error(function () {
          console.log(
            'Auth factory - failed to call check reset token ' + data.message
          );
        });
    };
    ...
    authFactory.resetPassword = function (token, password) {
      return $http
        ...
        .error(function () {
          console.log(
            'Auth factory - failed to reset password ' + data.message
          );
        });
    };
